...
- (void)setupSlideBar {
    ...
    slide.backgroundColor = ColorString(@"#F4F6FC");
    slide.itemColor = ColorString(@"#1F3F66");
    slide.itemSelectedColor = [UIColor whiteColor];
    slide.itemBgColor = ColorString(@"#F4F6FC");
    slide.itemSelectedBgColor = ColorString(@"#0091FF");
    slide.sliderColor = [UIColor whiteColor];
