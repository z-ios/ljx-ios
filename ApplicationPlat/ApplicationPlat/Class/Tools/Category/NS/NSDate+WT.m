...
+ (NSInteger)compareOneDay:(NSDate *)oneDay format:(NSString *)format withAnotherDay:(NSDate *)anotherDay
{
...
+ (NSString *)endtime:(NSString *)currenttime day:(NSString *)day
{
    ...
    //时间戳的值
    NSInteger int_day = [day integerValue];
    
    NSInteger endSp = timeSp+(int_day*24*3600);
    
    
    NSDate *datess = [NSDate dateWithTimeIntervalSince1970:endSp];
    NSString *dateString = [formatter stringFromDate: datess];
