...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.backgroundColor = ColorString(@"#F7F9FB");
        self.layer.borderColor = ColorString(@"#E4E7EA").CGColor;
        self.textColor = ColorString(@"#2F353A");
...
- (void)addRightPlaceHolder:(NSString *)placeHolder {
    CGFloat W = [placeHolder widthWithSize:12 h:20];
