...
- (MBProgressHUD *(^)(NHHUDContentStyle))hudContentStyle {
    return ^(NHHUDContentStyle hudContentStyle){
        if (hudContentStyle == NHHUDContentBlackStyle) {
            ...
            self.backgroundView.blurEffectStyle = UIBlurEffectStyleLight;
            
        } else if (hudContentStyle == NHHUDContentCustomStyle) {
                 self.contentColor = [UIColor colorWithRed:243/255.0f green:244/255.0f blue:245/255.0f alpha:1];
                   self.bezelView.color = [UIColor colorWithRed:33/255.0f green:35/255.0f blue:38/255.0f alpha:1];
            self.bezelView.style = MBProgressHUDBackgroundStyleBlur;
            self.bezelView.blurEffectStyle = UIBlurEffectStyleLight;
            self.backgroundView.blurEffectStyle = UIBlurEffectStyleLight;
