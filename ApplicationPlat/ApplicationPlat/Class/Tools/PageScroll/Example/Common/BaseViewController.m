...
//        if (i == 0) {
//            BreakerChildController *listVC = [[[self preferredListViewControllerClass] alloc] init];
////            listVC.iId =
...
//    }
    ...
    self.categoryView.frame = CGRectMake(10 * WidthScale, 0, WindowsSize.width- 20 * WidthScale, categoryViewHeight);
...
- (Class)preferredListViewControllerClass {
    return [BreakerChildController class];
}
