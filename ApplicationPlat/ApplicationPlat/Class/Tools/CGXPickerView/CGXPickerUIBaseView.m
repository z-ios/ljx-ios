...
- (UIView *)alertView {
    if (!_alertView) {
        _alertView = [[UIView alloc]initWithFrame:CGRectMake(0, KScreenHeight - self.manager.kTopViewH - self.manager.kPickerViewH, KScreenWidth, self.manager.kTopViewH + self.manager.kPickerViewH)];
...
- (UIView *)topView {
    if (!_topView) {
        _topView =[[UIView alloc]initWithFrame:CGRectMake(0, 0, KScreenWidth, self.manager.kTopViewH + 0.5)];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.frame = CGRectMake(KScreenWidth - 65, 7, 60, self.manager.kTopViewH-14);
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(65, 0, KScreenWidth - 130, self.manager.kTopViewH)];
...
- (UIView *)lineView {
    if (!_lineView) {
        _lineView = [[UIView alloc]initWithFrame:CGRectMake(0, self.manager.kTopViewH, KScreenWidth, 0.5)];
