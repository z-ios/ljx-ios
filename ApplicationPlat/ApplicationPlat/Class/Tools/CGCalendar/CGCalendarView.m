...
- (void)layoutSubviews {
    ...
    if (self.weekViewHeight > 0) {
        self.weekView.frame = CGRectMake(10 * WidthScale, 0, KScreenWidth - 50 * WidthScale, self.weekViewHeight);
    } else {
        self.weekView.frame = CGRectMake(10 * WidthScale, 0, KScreenWidth - 50 * WidthScale, 35);
    }
    
    // collecitonViewFrame
    self.collectionView.frame = CGRectMake(0 * WidthScale,
                                           CGRectGetMaxY(self.weekView.frame),
                                           KScreenWidth - 30 * WidthScale,
...
- (void)setWeekViewHeight:(CGFloat)weekViewHeight {
    ...
    self.weekView.height =  _weekViewHeight;
}
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.sectionHeaderIdentifier && [kind isEqualToString:UICollectionElementKindSectionHeader]) {
        ...
        UICollectionReusableView *footerView = [collectionView dequeueReusableSupplementaryViewOfKind:kind withReuseIdentifier:self.sectionFooterIdentifier forIndexPath:indexPath];
