...
- (void)setCellState:(CGRangeCalendarCellState)cellState {
    ...
    switch (_cellState) {
        ...
        case CGRangeCalendarCellStateSelectedStart: {
            self.dateLabel.backgroundColor =  ColorString(@"#D6E5FF");
...
//        self.contentView.backgroundColor = [UIColor colorWithRed:(20/255.f) green:(120/255.f) blue:(240/255.f) alpha:1.00f];
        self.contentView.backgroundColor =  ColorString(@"#D6E5FF");;
    }else {
    ...
    if ([self.date isToday])
    {
        switch (cellStatus) {
            ...
            default:
            {
                ...
                self.dateLabel.backgroundColor = [UIColor clearColor];
                self.todaySignLabel.backgroundColor =  [UIColor colorWithRed:(20/255.f) green:(120/255.f) blue:(240/255.f) alpha:1.00f];
            }
                break;
        }
    }
...
//        _leftLayerView.backgroundColor = [UIColor colorWithRed:0.91f green:0.95f blue:1.00f alpha:1.00f];
        _leftLayerView.backgroundColor =  ColorString(@"#D6E5FF");
...
//        _rightLayerView.backgroundColor = [UIColor colorWithRed:0.91f green:0.95f blue:1.00f alpha:1.00f];
        _rightLayerView.backgroundColor =  ColorString(@"#D6E5FF");
...
- (UILabel *)todaySignLabel {
    if (!_todaySignLabel) {
        ...
        _todaySignLabel.backgroundColor =  [UIColor colorWithRed:(20/255.f) green:(120/255.f) blue:(240/255.f) alpha:1.00f];
    }
