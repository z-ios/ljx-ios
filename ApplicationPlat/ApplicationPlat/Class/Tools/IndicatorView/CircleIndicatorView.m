...
#define DefaultFont(fontsize) SystemVersion >= 9.0 ? [UIFont fontWithName:@"Rubik-Light" size:(fontsize)] : [UIFont systemFontOfSize:(fontsize)]
...
- (void)updateUI {
    //━━━━━━━━━━━━━━━━━━━━ 中间的数值 ━━━━━━━━━━━━━━━━━━━━
    NSString *valueString = [NSString stringWithFormat:@"%@%@", @(self.centerValue), @"%"];
    ...
    [stringM addAttribute:NSFontAttributeName value:DefaultFont(17) range:NSMakeRange(0, stringM.length - 1)]; // 设置字体字号
    [stringM addAttribute:NSFontAttributeName value:DefaultFont(8) range:NSMakeRange(range.location, 1)]; // 设置字体字号
    ...
    self.centerValueLabel.center = CGPointMake(self.circleCenter.x + self.centerValueLabelXOffset, self.circleCenter.y - self.centerValueLabelYOffset * 6);
...
- (void)addLayer2 {
    ...
    [layer2_GradientLayer setColors:@[(id)ColorString(@"#FB6E10").CGColor,
                                      (id)ColorString(@"#FB6E10").CGColor,
                                      (id)ColorString(@"#FB6E10").CGColor]];
...
//    indicatorLabel.text = [NSString stringWithFormat:@"%@", @(self.indicatorValue)];
